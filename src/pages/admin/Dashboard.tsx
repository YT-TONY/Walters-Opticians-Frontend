...
const mapBackendToAdminProduct = (p: BackendProduct): AdminProduct => ({
  ...
  frameType: (p.frame_type as FrameType) || 'full-rim',
  description: p.description || '',
  frame_material: p.frame_material || 'Plastic',
  lens_material: p.lens_material || 'Demo Lens',
  lens_color: p.lens_color || 'Transparent',
  glass_base: p.glass_base || 'Base 4',
  polarized: p.polarized ?? false,
  photochromic: p.photochromic ?? false,
  gradables: p.gradables ?? false,
  lens_width: p.lens_width ?? 54.0,
  bridge_width: p.bridge_width ?? 17.0,
  temple_length: p.temple_length ?? 140.0,
  lens_height: p.lens_height ?? 38.0,
...
const mapAdminToBackendCreate = (formData: Omit<AdminProduct, 'id'>) => ({
  ...
  glass_base: formData.glass_base,
  polarized: formData.polarized,
  photochromic: formData.photochromic,
  gradables: formData.gradables,
  lens_width: formData.lens_width,
  bridge_width: formData.bridge_width,
  temple_length: formData.temple_length,
  lens_height: formData.lens_height,
